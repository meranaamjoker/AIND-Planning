...
class AirCargoProblem(Problem):
            ...
            for airport in self.airports:
                for plane in self.planes:
                    for cargo in self.cargos:
                        precond_positive = [expr("At({}, {})".format(cargo, airport)),
                                            expr("At({}, {})".format(plane, airport))]
                        precond_negative = [expr("In({}, {})".format(cargo, plane))]
                        precond_negative = []
                        effect_add = [expr("In({}, {})".format(cargo, plane))]
                        effect_remove = [expr("At({}, {})".format(cargo, airport))]
    ...
    def actions(self, state: str) -> list:
        ...
        # Get a handle to knowledge base of logical expressions
        kb = PropKB()

        # Add the current state's positive sentence's clauses to KB
